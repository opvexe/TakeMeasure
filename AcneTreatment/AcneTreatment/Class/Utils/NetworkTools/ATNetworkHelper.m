...
@implementation ATNetworkHelper
...
+ (NSURLSessionTask *)WithMethodGET:(NSString *)URL
    ...
    responseCache!=nil ? responseCache([ATNetworkCache httpCacheForURL:URL parameters:parameters]) : nil;
    ...
    sessionTask  = [_sessionManager GET:URL parameters:parameters progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        if (responseCache!=nil) {
            [ATNetworkCache setHttpCache:responseObject URL:URL parameters:parameters];
        }
        if (isDebug) {
