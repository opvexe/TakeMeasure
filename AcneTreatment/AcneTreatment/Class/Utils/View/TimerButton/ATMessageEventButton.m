...
@interface ATMessageEventButton (){
    NSUInteger _countdown;
    NSTimer * _countdownTimer;
}
@end

@implementation ATMessageEventButton
...
- (void)setupSendSNSCodeButton {
    ...
    [self setBackgroundImage:[UIImage imageWithColor:[UIColor TextColor]] forState:UIControlStateDisabled];
